...
namespace WhiteLagoon.Web.Controllers
{
    ...
    // Admin users only can access it
    ...
    public class AmenityController : Controller
    {
        ...
        {
            // To ignore Villa from validation, another way to To ignore Villa from validation write up Villa prop in Amenity class[validatenever]            
