...
//using Stripe.BillingPortal; // xxxxxxxxxxx
    ...
    public class BookingController : Controller
    {
        ...
        public IActionResult BookingConfirmation (int bookingId)
        {
            ...
            if (bookingFromDb.Status == SD.StatusPending)
            {
                ...
                var service = new CheckoutSessionService(); //rather than --> var service = new SessionService();
                CheckoutSession session = service.Get(bookingFromDb.StripeSessionId); //rather than --> Session session = service.Get(bookingFromDb.StripeSessionId);
